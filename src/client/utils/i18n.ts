...
export const zh = {
  ...
  "pl.lexicon.confirmBatchDelete": "删除选中的 {count} 条提示词？删除后将移入回收站，可在「词库管理 - 回收站」中恢复。",
  ...
  "pl.trashRestoreSelected": "恢复",
  "pl.trashDeleteSelected": "删除",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.lexicon.title": "Lexicon Manager",
  ...
  "pl.lexicon.confirmBatchDelete": "Delete {count} selected prompts? They will be moved to the recycle bin and can be restored from Lexicon Manager → Recycle Bin.",
  ...
  "pl.trashRestoreSelected": "Restore",
  "pl.trashDeleteSelected": "Delete",
