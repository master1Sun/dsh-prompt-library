...
import { mkdir as mkdir3, readFile as readFile4, readdir as readdir3, stat as stat3, writeFile as writeFile4 } from "node:fs/promises";
...
async function readPreviewFile(p) {
  ...
  return { name: basename3(p), path: p, content, size: s.size, type };
}
