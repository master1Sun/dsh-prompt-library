...
function ModuleCard2(props) {
  const { title, desc, open, onToggle, children } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("section", { style: moduleStyle2, children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: moduleTitleStyle2, children: title }),
            desc && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: moduleDescStyle2, children: desc })
          ] }),
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children })
  ] });
}
function PromptCheckRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
    "label",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("input", { type: "checkbox", checked, onChange: onToggle, style: { marginTop: 2 } }),
...
function SettingsDataSection(props) {
  ...
  const [skillGenerating, setSkillGenerating] = (0, import_react13.useState)(false);
  ...
  const [openIE, setOpenIE] = (0, import_react13.useState)(false);
  const [openTags, setOpenTags] = (0, import_react13.useState)(false);
  const [openTrash, setOpenTrash] = (0, import_react13.useState)(false);
  ...
  const refreshPrompts = (0, import_react13.useCallback)(() => {
  ...
  const generateSelectedSkills = (0, import_react13.useCallback)(() => {
    const ids = Array.from(exportSelected);
    if (ids.length === 0) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { color: TONE13.text, fontFamily: MONO12, maxWidth: 640 }, children: [
...
` }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { padding: "2px 0 4px", display: "flex", flexDirection: "column", gap: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { fontSize: 20, fontWeight: 700, letterSpacing: 1, color: TONE13.text, lineHeight: 1.2 }, children: T("pl.set.dataSection") }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 12, color: TONE13.quiet, lineHeight: 1.5 }, children: T("pl.set.dataSectionDesc") })
    ] }),
      ...
      ModuleCard2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "inline-flex", borderRadius: 7, border: `1px solid ${TONE13.border}`, overflow: "hidden" }, children: ["list", "group"].map((view) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  color: exportView === view ? TONE13.text : TONE13.muted,
                  transition: "background-color .24s cubic-bezier(.22,1,.36,1), color .24s cubic-bezier(.22,1,.36,1)"
                },
            ...
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 11, color: TONE13.quiet }, children: exportSelected.size > 0 ? `${exportSelected.size}/${promptList.length}` : T("pl.sidebar.total", { count: promptList.length }) })
          ] }),
          promptLoading ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE13.muted }, children: T("pl.loading") }) : promptList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE13.muted }, children: T("pl.empty") }) : exportView === "group" ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10, maxHeight: 300, overflow: "auto" }, children: groupedPrompts.map(([group, prompts]) => {
            const groupChecked = prompts.length > 0 && prompts.every((p) => exportSelected.has(p.id));
            const collapsed = exportCollapsed.has(group);
            return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 5 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontWeight: 560 }, children: group }),
                      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 11, color: TONE13.quiet }, children: T("pl.sidebar.groupCount", { count: prompts.length }) })
                    ]
                  }
                )
              ] }),
              !collapsed && prompts.map((prompt) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                PromptCheckRow,
                {
          ...
          }) }) : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 300, overflow: "auto" }, children: promptList.map((prompt) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
            PromptCheckRow,
            {
              title: prompt.title || T("pl.sidebar.uncategorized"),
              body: prompt.body,
      ...
      ModuleCard2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives9.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: addTag, children: T("pl.createTag") })
          ] }),
          tagList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { padding: "10px 0", fontSize: 12, color: TONE13.muted }, children: T("pl.tagsNone") }) : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 300, overflow: "auto" }, children: tagList.map((tag) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
              "div",
              {
                ...
                children: editing ? /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives9.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => setRenamingTag(null), children: T("pl.cancel") }),
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives9.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: confirmRenameTag, children: T("pl.save") })
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 11, color: TONE13.quiet, flexShrink: 0 }, children: tag.count }),
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                    import_dsh_client_ui_primitives9.Button,
                    {
                      type: "button",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
      ModuleCard2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { fontSize: 11, lineHeight: 1.5, color: TONE13.quiet, background: TONE13.row, border: `1px solid ${TONE13.border}`, borderRadius: 6, padding: "6px 10px" }, children: T("pl.trashCleanupNote") }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
              "label",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
              import_dsh_client_ui_primitives9.Button,
              {
                ...
                disabled: trashSelected.size === 0,
                style: { color: TONE13.red },
                children: T("pl.trashDeleteSelected")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 11, color: TONE13.quiet }, children: trashSelected.size > 0 ? `${trashSelected.size}/${trashList.length}` : "" })
          ] }),
          trashLoading ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE13.muted }, children: T("pl.loading") }) : trashList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE13.muted }, children: T("pl.trashEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 320, overflow: "auto" }, children: trashList.map((item) => /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 3 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", minWidth: 0 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { fontSize: 10, color: TONE13.quiet, flexShrink: 0, whiteSpace: "nowrap" }, children: T("pl.trashDeletedAt", { time: formatTime(item.deletedAt) }) })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives9.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => restoreOne(item), children: T("pl.trashRestoreOne") }),
                    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives9.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => deleteOne(item), style: { color: TONE13.red }, children: T("pl.trashDeleteOne") }),
                    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                      "span",
                      {
                        style: {
                          fontSize: 10,
                          color: daysLeft(item.deletedAt) <= 1 ? TONE13.red : TONE13.quiet,
                          marginLeft: "auto",
                          flexShrink: 0
                        },
    ...
    pendingConfirm && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "div",
      {
        style: {
          position: "fixed",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: 10 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                  import_dsh_client_ui_primitives9.Button,
                  {
                    ...
                    size: "sm",
                    className: plBtn("primary", "sm"),
                    style: pendingConfirm.danger ? { color: TONE13.red } : void 0,
                    onClick: () => {
