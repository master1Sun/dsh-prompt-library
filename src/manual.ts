...
export const manualZh = [
  ...
  "【二、核心命令】",
  "（/prompts 后务必加一个空格再输入）",
  "/prompts -add <正文>        把正文保存到词库，AI 自动生成标题与标签",
  "/prompts -tag <标签> <正文>  按指定标签保存到词库",
  "/prompts -s <关键词>        检索词库，列出标题/正文匹配的提示词",
  "/prompts -enrich <正文>     AI 专业完善：与 -AI 润色相反，扩写完善为更专业/全面/结构完整的版本，结果打印在聊天返回、自行复制",
  "/prompts -e                导出全部提示词（纯文本，可直接复制）",
  "/prompts -data             输出词库使用统计，末尾附 AI 点评",
  "/prompts -AI <正文>        对 <正文> 做 AI 润色，结果打印在聊天返回、自行复制（-AI/-ai/-a/-A 均可）",
...
export const manualEn = [
  ...
  "/prompts -add <body>          Save the body; AI generates title and tags",
  "/prompts -tag <tag> <body>   Save the body with a specific tag",
  "/prompts -s <keyword>        Search the library and list prompts matching the title/body",
  "/prompts -enrich <body>     AI professional enrichment: opposite of -AI polish, expand into a more professional/complete/structured version; result printed in chat for you to copy",
  "/prompts -e                 Export all prompts (plain text, ready to copy)",
  "/prompts -data              Output library usage stats with an AI comment at the end",
  "/prompts -AI <body>     AI-polish the body; result printed in chat for you to copy (-AI/-ai/-a/-A all work)",
