...
// src/client/PromptLibraryButton.tsx
...
// src/client/SidebarPromptLibrary.tsx
var import_react5 = require("react");

// src/client/recent-created.ts
...
// src/client/PromptAssistant.tsx
...
function PromptAssistant(props) {
  ...
  const T = usePLT(t);
  const [pos, setPos] = (0, import_react3.useState)(loadPos);
  const updatePos = (0, import_react3.useCallback)((patch) => {
    setPos((prev) => {
  ...
  const viewportRef = (0, import_react3.useRef)({ w: window.innerWidth, h: window.innerHeight });
  const [viewVersion, setViewVersion] = (0, import_react3.useState)(0);
  ...
  const [bubble, setBubble] = (0, import_react3.useState)(false);
  const bubbleRef = (0, import_react3.useRef)(null);
  const [bubbleW, setBubbleW] = (0, import_react3.useState)(176);
  const [bubbleH, setBubbleH] = (0, import_react3.useState)(56);
  (0, import_react3.useEffect)(() => {
  ...
  const hoverRef = (0, import_react3.useRef)(false);
  const lastActiveRef = (0, import_react3.useRef)(Date.now());
  const [docked, setDocked] = (0, import_react3.useState)(false);
  const dockedRef = (0, import_react3.useRef)(false);
  const preDockRef = (0, import_react3.useRef)(null);
  const bubbleRefId = (0, import_react3.useRef)(false);
  (0, import_react3.useEffect)(() => {
    bubbleRefId.current = bubble;
  }, [bubble]);
  const [dragging, setDragging] = (0, import_react3.useState)(false);
  const lastCursorRef = (0, import_react3.useRef)(null);
  (0, import_react3.useEffect)(() => {
  ...
  const [intros, setIntros] = (0, import_react3.useState)(() => [
    T("pl.intro.0"),
    T("pl.intro.1"),
    T("pl.intro.2"),
    T("pl.intro.3"),
  ...
  const [update, setUpdate] = (0, import_react3.useState)(null);
  ...
  const personDragRef = (0, import_react3.useRef)(null);
  ...
  const [introIdx, setIntroIdx] = (0, import_react3.useState)(0);
  const rotMs = 2500;
  (0, import_react3.useEffect)(() => {
    if (!bubble) {
      setIntroIdx(0);
  ...
  const bubblePos = (0, import_react3.useMemo)(() => {
  ...
  const updateText = update?.hasBeta ? settings?.experienceProgramEnabled ?? DEFAULT_SETTINGS.experienceProgramEnabled ? T("pl.update.detectedBeta") : T("pl.update.detected") : "";
...
` }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        children: [
          bubble && bubblePos && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "div",
            {
              ref: bubbleRef,
              style: {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontWeight: 600, letterSpacing: 2, marginBottom: 4 }, children: T("pl.floating.title") }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "flex", gap: 4, justifyContent: "center", marginTop: 7 }, children: intros.map((_, i) => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "relative", width: "100%", height: "100%", pointerEvents: "none" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: PERSON_SIZE, height: PERSON_SIZE, viewBox: "0 0 72 72", fill: "none", style: { position: "absolute", inset: 0, animation: "pl-person-bob 2.6s ease-in-out infinite", pointerEvents: "none", filter: "drop-shadow(0 2px 7px color-mix(in srgb, var(--dsw-alias-brand-primary, #2563eb) 45%, transparent))" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("title", { children: T("pl.title") }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M22 47 C18 47 14 42 13 34 C12 26 18 21 25 20 C22 15 26 11 33 12 C40 11 44 15 41 20 C48 21 54 26 53 34 C52 42 48 47 44 47 Z", fill: "var(--dsw-alias-brand-primary, #2563eb)", opacity: ".16" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { className: "pl-person-arm", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ellipse", { cx: "36", cy: "52", rx: "12", ry: "9", fill: "var(--dsw-alias-brand-primary, #2563eb)", opacity: "0.85" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ellipse", { cx: "26", cy: "50", rx: "5", ry: "4", fill: "var(--dsw-alias-interactive-bg-hover, rgba(100,116,139,.4))" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "36", cy: "34", r: "15", fill: "var(--dsw-alias-brand-primary, #2563eb)" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "29", cy: "37", r: "2.4", fill: "#fff", opacity: ".55" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "43", cy: "37", r: "2.4", fill: "#fff", opacity: ".55" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { style: { animation: "pl-person-blink 4s ease-in-out infinite", transformOrigin: "32px 34px" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "31", cy: "33", r: "2.6", fill: "#fff" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "41", cy: "33", r: "2.6", fill: "#fff" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "32", cy: "33.6", r: "1.2", fill: "#10141c" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "42", cy: "33.6", r: "1.2", fill: "#10141c" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M30 39.5 Q36 43.5 42 39.5", stroke: "#fff", strokeWidth: "1.8", strokeLinecap: "round" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "div",
              {
          ...
          update?.hasBeta && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "span",
            {
              role: "button",
...
function TagFilterBar(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: barStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => onChange(""), style: chip(active === ""), children: allLabel ?? "\u5168\u90E8" }),
...
function Highlight({ text, query }) {
  const q = query?.trim();
  if (!q) return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: text });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: nodes });
}
function SearchBox({
  value,
  onChange,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { position: "relative", width: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "11", cy: "11", r: "7" }),
    ...
    hasText && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "button",
      {
        type: "button",
        title: "\u6E05\u9664",
...
function TagInput({ value, onChange, suggestions, inputStyle: inputStyle6, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { width: "100%", boxSizing: "border-box", display: "flex", flexDirection: "column", gap: 3 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: "", children: T("pl.tagsNoneSelect") }),
          suggestions.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: tag, children: tag }, tag))
        ]
      }
    ),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: 10 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", style: { ...btn, color: TEXT }, onMouseEnter: (e) => Object.assign(e.currentTarget.style, hover), onMouseLeave: (e) => {
...
// src/client/TemplateVariables.tsx
...
function renderPreview(body, values, colorOf, focusName) {
  ...
  while ((m = re.exec(body)) !== null) {
    ...
    if (val && val.trim()) {
      nodes.push(
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: hlStrong(color, active), title: `{{${name}}}`, children: val }, `f${key++}`)
      );
    } else {
      nodes.push(
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: hlPlaceholder(color, active), children: `{{${name}}}` }, `p${key++}`)
      );
    }
...
function TemplateFillModal({
  ...
  const [focusName, setFocusName] = (0, import_react4.useState)(null);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { style: { fontSize: 15, fontWeight: 520, paddingBottom: 4, flexShrink: 0 }, children: t("pl.template.title") }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 12, color: TONE4.muted, lineHeight: 1.6, flexShrink: 0 }, children: t("pl.template.desc") }),
                ...
                children: variables.map((name) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
                    "label",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { display: "flex", alignItems: "center", gap: 6 }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                          "span",
                          {
                            style: {
                              fontSize: 11,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: 11, color: TONE4.muted }, children: t("pl.template.preview") }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                    "div",
                    {
                      style: {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end", paddingTop: 6, flexShrink: 0 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: onCancel, children: t("pl.cancel") }),
              showInsertAndSend && onInsertAndSend && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: submit, children: confirmLabel ?? t("pl.insert") })
            ] })
          ]
        }
      )
...
function clampPos(x, y, width, height) {
  ...
  const vh = window.innerHeight;
  return {
    x: Math.min(Math.max(FLOAT_MARGIN2, x), Math.max(FLOAT_MARGIN2, vw - width - FLOAT_MARGIN2)),
    y: Math.min(Math.max(FLOAT_MARGIN2, y), Math.max(FLOAT_MARGIN2, vh - height - FLOAT_MARGIN2))
  };
}
...
function SidebarPromptLibrary(props) {
  ...
  const [float, setFloat] = (0, import_react5.useState)(loadFloatState);
  const collapsed = float.collapsed;
  const setCollapsed = (0, import_react5.useCallback)(
  ...
  const [prompts, setPrompts] = (0, import_react5.useState)([]);
  const [tagNames, setTagNames] = (0, import_react5.useState)([]);
  const [query, setQuery] = (0, import_react5.useState)("");
  const [tagFilter, setTagFilter] = (0, import_react5.useState)("");
  const clearSearch = (0, import_react5.useCallback)(() => setQuery(""), []);
  const [phase, setPhase] = (0, import_react5.useState)("idle");
  const [error, setError] = (0, import_react5.useState)(null);
  const [editor, setEditor] = (0, import_react5.useState)(NO_EDITOR);
  const [copiedId, setCopiedId] = (0, import_react5.useState)(null);
  const [polish, setPolish] = (0, import_react5.useState)({ status: "idle" });
  const [polishResult, setPolishResult] = (0, import_react5.useState)("");
  const [polishError, setPolishError] = (0, import_react5.useState)(null);
  const [polishInsert, setPolishInsert] = (0, import_react5.useState)(null);
  const [template, setTemplate] = (0, import_react5.useState)(null);
  const [deleteConfirm, setDeleteConfirm] = (0, import_react5.useState)(null);
  ...
  const toggleGroup = (0, import_react5.useCallback)((tag) => {
  ...
  const [recentCollapsed, setRecentCollapsed] = (0, import_react5.useState)(false);
  const searchRef = (0, import_react5.useRef)(null);
  const refreshController = (0, import_react5.useRef)(null);
  ...
  const [viewTick, setViewTick] = (0, import_react5.useState)(0);
  (0, import_react5.useEffect)(() => {
    const onViewport = () => setViewTick((t2) => t2 + 1);
    window.addEventListener("resize", onViewport);
  ...
  const startResize = (e) => {
    ...
    const onMove = (ev) => {
      ...
      const vw = window.innerWidth;
      const vh = window.innerHeight;
      const width = Math.min(Math.max(r.ow + (ev.clientX - r.startX), FLOAT_MIN_W), vw - view.x - FLOAT_MARGIN2);
      const height = Math.min(Math.max(r.oh + (ev.clientY - r.startY), FLOAT_MIN_H), vh - view.y - FLOAT_MARGIN2);
  ...
  const preSearchExpanded = (0, import_react5.useRef)(null);
  (0, import_react5.useEffect)(() => {
  ...
  const insertText = (0, import_react5.useCallback)(
    (text) => {
      if (inputActions) {
...
${text}` : text);
  ...
  const overwrite = (0, import_react5.useCallback)(
    (prompt) => {
      if (hasVariables(prompt.body)) {
  ...
  const applyTemplate = (0, import_react5.useCallback)(
    (values) => {
      if (!template) return;
  ...
  const applyPolishInsert = (0, import_react5.useCallback)(
    (values) => {
  ...
  const insertAndSend = (0, import_react5.useCallback)(
    (values) => {
  ...
  const copy = (0, import_react5.useCallback)((p) => {
  ...
  const startPolish = (0, import_react5.useCallback)((p) => {
    setPolishError(null);
  ...
  const closePolish = (0, import_react5.useCallback)(() => {
    setPolish({ status: "idle" });
    setError(null);
    setPolishInsert(null);
  }, []);
  ...
  const savePolish = (0, import_react5.useCallback)(() => {
  ...
  const tagGrouped = (0, import_react5.useMemo)(() => {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { width: "11", height: "11", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M7 17L17 7M9 17h8V9", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
            "header",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: 7, minWidth: 0, flex: 1 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                    "svg",
                    {
                      width: "15",
                      ...
                      style: { flexShrink: 0 },
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M4 5h11a3 3 0 0 1 3 3v11l-3-2-3 2V8a3 3 0 0 0-3-3H4Z", strokeLinejoin: "round" }),
                        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M8 9h3M8 12h3", strokeLinecap: "round" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                ...
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { justifySelf: "end", display: "flex", gap: 6, alignItems: "center", flexShrink: 0 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    import_dsh_client_ui_primitives2.Button,
                    {
                      ...
                      icon: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M3 8l9 9 9-9" }) })
                    }
                  )
                ] })
              ]
          ...
          !editing && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { padding: "0px 12px", flexShrink: 0, margin: "12px 12px 0" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                SearchBox,
                {
                  inputRef: searchRef,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { ref: scrollRef, style: { flex: 1, overflow: "auto", marginRight: 2 }, children: [
              phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { padding: "20px 12px", color: TONE5.muted, fontSize: 13, textAlign: "center" }, children: T("pl.loading") }),
              phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { padding: "12px 12px", color: TONE5.red, fontSize: 13 }, children: error }),
              polishError && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "div",
                {
                  style: {
                    padding: "9px 12px",
              ...
              polish.status === "done" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { padding: "12px 16px", display: "flex", flexDirection: "column", gap: 9 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("strong", { style: { fontSize: 13 }, children: T("pl.polishResult") }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: closePolish, children: T("pl.close") })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "textarea",
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end", flexWrap: "wrap" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: savePolish, children: T("pl.saveToLibrary") })
                ] })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
                phase === "ready" && filtered.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { padding: "16px 12px", color: TONE5.muted, fontSize: 13, textAlign: "center" }, children: T("pl.empty") }),
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { display: "inline-flex", width: 12, justifyContent: "center", flexShrink: 0 }, children: isRecentSection ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", "aria-hidden": "true", children: [
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { cx: "12", cy: "12", r: "9" }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M12 7v5l3 2" })
                          ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: 10 }, children: isCollapsed ? "\u25B6" : "\u25BC" }) }),
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: tag }),
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: 10, opacity: 0.6 }, children: T("pl.sidebar.groupCount", { count: items.length }) })
                        ]
                      }
                    ),
                    !isCollapsed && items.map((p) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                      "div",
                      {
                        "data-pl-id": p.id,
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", minWidth: 0 }, children: [
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("strong", { style: {
                              ...
                              overflow: "hidden",
                              textOverflow: "ellipsis"
                            }, title: p.title, children: query.trim() ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Highlight, { text: clampTitle(p.title), query }) : clampTitle(p.title) }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "center", flexShrink: 0 }, children: [
                              ...
                              p.usageCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { color: TONE5.quiet, fontSize: 10, whiteSpace: "nowrap" }, children: T("pl.sidebar.usageCount", { count: p.usageCount }) })
                            ] })
                          ] }),
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                            "pre",
                            {
                              ...
                              children: query.trim() ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Highlight, { text: p.body, query }) : p.body
                            }
                          ),
                          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: () => insert(p), children: T("pl.insert") }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => overwrite(p), children: T("pl.overwrite") }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => copy(p), children: copiedId === p.id ? T("pl.copied") : T("pl.copy") }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => startEdit(p), children: T("pl.edit") }),
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                              import_dsh_client_ui_primitives2.Button,
                              {
                                type: "button",
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => remove(p), children: T("pl.delete") })
                          ] })
                        ]
                      },
                      p.id
          ...
          editing && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { flex: 1, overflow: "auto", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 9 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE5.muted }, children: [
              T("pl.tagsField"),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(TagInput, { value: editor.tags, onChange: (v) => setEditor({ ...editor, tags: v }), suggestions: allTags, inputStyle: inputStyle2, t })
            ] }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives2.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: saveEditor, children: T("pl.save") })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
            "footer",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: T("pl.sidebar.tagTotal", {
                  count: tagGrouped.filter(
                    ([k]) => k !== T("pl.sidebar.recent") && k !== T("pl.sidebar.uncategorized")
                  ).length
                }) }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: T("pl.sidebar.total", { count: prompts.length }) })
              ]
            }
          )
        ]
...
// src/client/SelectionAddPrompt.tsx
...
function SelectionAddPrompt(props) {
  ...
  const copyingRef = (0, import_react6.useRef)(false);
  ...
  const loadTags = (0, import_react6.useCallback)(() => {
    if (!enabled) return;
...
` }),
    enabled && selection && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        style: {
          position: "fixed",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "button",
            {
              ...
              children: [
                copied ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M20 6 9 17l-5-5", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: "9", y: "9", width: "11", height: "11", rx: "2", stroke: "currentColor", strokeWidth: "1.8" }),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M5 15V6a2 2 0 0 1 2-2h9", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round" })
                ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "button",
            {
              ...
              style: floatingBtnStyle,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M12 5v14M5 12h14", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }) }),
                T("pl.addToLibrary")
              ]
            }
          )
    ...
    enabled && open && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "div",
      {
        role: "dialog",
        "aria-modal": "true",
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("strong", { style: { fontSize: 15, fontWeight: 520, paddingBottom: 6, flexShrink: 0 }, children: T("pl.addToLibrary") }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { flex: 1, minHeight: 0, overflow: "auto", display: "flex", flexDirection: "column", gap: 9 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE6.muted, flexShrink: 0 }, children: [
                  T("pl.titleField"),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { autoFocus: true, value: title, onChange: (e) => setTitle(e.target.value), style: inputStyle3 })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE6.muted, flexShrink: 0 }, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("textarea", { ref: bodyRef, value: body, onChange: (e) => setBody(e.target.value), rows: 8, style: { ...inputStyle3, resize: "vertical" } })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE6.muted, flexShrink: 0 }, children: [
                  T("pl.tagsField"),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TagInput, { value: tags, onChange: setTags, suggestions: allTags, inputStyle: inputStyle3, t: props?.t })
                ] }),
                error && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { color: TONE6.red, fontSize: 12, flexShrink: 0 }, children: error })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end", paddingTop: 4, flexShrink: 0 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_dsh_client_ui_primitives3.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: closeModal, disabled: saving, children: T("pl.cancel") }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_dsh_client_ui_primitives3.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: save, disabled: saving, children: saving ? T("pl.saving") : T("pl.save") })
              ] })
            ]
          }
        )
...
function Pagination({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { fontSize: 12, color: TONE7.muted }, children: [
          page,
          " / ",
          totalPages
        ] }),
...
function useAutoLearn(draft, existingPrompts, settings, onLearned, onManual) {
  ...
  const submittedRef = (0, import_react7.useRef)(/* @__PURE__ */ new Set());
...
function useTildaTrigger(settings, prompts, inputActions, draft, t, onSelect) {
  ...
  const triggerIdxRef = (0, import_react8.useRef)(-1);
  const draftRef = (0, import_react8.useRef)(draft);
  const inputActionsRef = (0, import_react8.useRef)(inputActions);
  const onSelectRef = (0, import_react8.useRef)(onSelect);
...
function useSettings2() {
  const [settings, setSettings] = (0, import_react8.useState)(DEFAULT_SETTINGS);
...
function PromptLibraryButton(props) {
  ...
  const [deleteConfirm, setDeleteConfirm] = (0, import_react8.useState)(null);
  const [tagNames, setTagNames] = (0, import_react8.useState)([]);
  const [phase, setPhase] = (0, import_react8.useState)("idle");
  const [error, setError] = (0, import_react8.useState)(null);
  const [query, setQuery] = (0, import_react8.useState)("");
  const clearSearch = (0, import_react8.useCallback)(() => setQuery(""), []);
  const [editor, setEditor] = (0, import_react8.useState)({
    mode: "none",
    title: "",
    body: "",
    tags: ""
  ...
  const [toast, setToast] = (0, import_react8.useState)({ visible: false });
  const [template, setTemplate] = (0, import_react8.useState)(null);
  const [pendingConfirm, setPendingConfirm] = (0, import_react8.useState)(null);
  const [polishConfirmUsed, setPolishConfirmUsed] = (0, import_react8.useState)(false);
  const [polishConfirmLoading, setPolishConfirmLoading] = (0, import_react8.useState)(false);
  const [settings] = useSettings2();
  const panelId = (0, import_react8.useId)();
  const refreshController = (0, import_react8.useRef)(null);
  useFillDraft((body) => {
    if (body) inputActions.setDraft(body);
  });
  const showToast = (0, import_react8.useCallback)((text) => {
  ...
  useDataChanged(refresh);
  useExportDownloaded((0, import_react8.useCallback)((count) => {
  ...
  useAutoLearn(
    ...
    prompts,
    settings,
    (0, import_react8.useCallback)((learned) => {
      notifyDataChanged();
      showToast();
    ...
    (0, import_react8.useCallback)((text) => {
  ...
  const insert = (0, import_react8.useCallback)(
    (prompt) => {
      if (hasVariables(prompt.body)) {
        setTemplate({ prompt, mode: "insert" });
        return;
...
${body}` : body);
  ...
  const selectFromOverlay = (0, import_react8.useCallback)(
    (p) => {
  ...
  const overwrite = (0, import_react8.useCallback)(
    (prompt) => {
      if (hasVariables(prompt.body)) {
        setTemplate({ prompt, mode: "overwrite" });
        return;
  ...
  const applyTemplate = (0, import_react8.useCallback)(
    (values) => {
      if (!template) return;
      const filled = applyVariables(template.prompt.body, values);
      usePrompt(template.prompt.id).catch(() => {
...
${filled}` : filled);
  ...
  const insertAndSend = (0, import_react8.useCallback)(
    (values) => {
      if (!template) return;
      const filled = applyVariables(template.prompt.body, values);
      usePrompt(template.prompt.id).catch(() => {
...
${filled}` : filled;
  ...
  const confirmLearn = (0, import_react8.useCallback)(async () => {
  ...
  const cancelLearn = (0, import_react8.useCallback)(() => {
    setPendingConfirm(null);
    setPolishConfirmLoading(false);
    setPolishConfirmUsed(false);
  }, []);
  const polishLearnText = (0, import_react8.useCallback)(async () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { "data-prompt-library": true, style: containerStyle, children: [
    ...
    showComposerButton && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
        import_dsh_client_ui_primitives5.Button,
        {
          ...
          icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: "M8 9h3M8 12h3", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" })
          ] }),
          children: [
            T("pl.title"),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", style: {
              marginLeft: 2,
              transform: open ? "rotate(180deg)" : "rotate(0deg)",
              transition: "transform 0.2s ease"
            }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: "M6 9l6 6 6-6", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })
          ]
        }
      ),
      toast.visible && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
        "span",
        {
          role: "status",
          "aria-live": "polite",
      ...
      pendingConfirm !== null && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
        "span",
        {
          role: "dialog",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { fontSize: 12, fontWeight: 600 }, children: T("pl.learnFound") }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                import_dsh_client_ui_primitives5.Button,
                {
                  type: "button",
      ...
      open && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_jsx_runtime10.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { id: panelId, role: "dialog", "aria-label": T("pl.title"), style: panelStyle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
          "header",
          {
            style: {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: 6, minWidth: 0 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", style: { flexShrink: 0 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: "M4 5h11a3 3 0 0 1 3 3v11l-3-2-3 2V8a3 3 0 0 0-3-3H4Z", stroke: "currentColor", strokeWidth: "1.6", strokeLinejoin: "round" }),
                  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: "M8 9h3M8 12h3", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("strong", { style: { fontSize: 14, fontWeight: 470, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: T("pl.title") })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                  import_dsh_client_ui_primitives5.Button,
                  {
                    type: "button",
        ...
        !editing && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { padding: "10px 16px", flexShrink: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          SearchBox,
          {
            value: query,
            onChange: setQuery,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { flex: 1, overflow: "auto", minHeight: 0 }, children: [
          phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { padding: "20px 16px", color: TONE8.muted, fontSize: 13, textAlign: "center" }, children: T("pl.loading") }),
          phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { padding: "12px 16px", color: TONE8.red, fontSize: 13 }, children: error }),
          editing ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { padding: "12px 16px", display: "flex", flexDirection: "column", gap: 9 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE8.muted }, children: [
              T("pl.titleField"),
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                "input",
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE8.muted }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: TONE8.muted }, children: [
              T("pl.tagsField"),
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TagInput, { value: editor.tags, onChange: (v) => setEditor({ ...editor, tags: v }), suggestions: allTags, inputStyle: inputStyle4, t })
            ] }),
            error && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { color: TONE8.red, fontSize: 12 }, children: error })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("ul", { style: { listStyle: "none", margin: 0, padding: 0 }, children: [
            phase === "ready" && filtered.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("li", { style: { padding: "16px", color: TONE8.muted, fontSize: 13, textAlign: "center" }, children: T("pl.empty") }),
            pageItems.map((p) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
              "li",
              {
                style: {
                  padding: "10px 16px",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", minWidth: 0 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { display: "flex", gap: 6, alignItems: "center", flexShrink: 0 }, children: isRecent(p.id) && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                      "span",
                      {
                        title: T("pl.recentNew"),
                        style: { width: 8, height: 8, borderRadius: "50%", background: TONE8.mint, display: "inline-block", flexShrink: 0 }
                      }
                    ) })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        ...
        editing && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
          "div",
          {
            style: {
              flexShrink: 0,
        ...
        !editing && phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Pagination, { page, totalPages, onChange: setPage })
      ] }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarPromptLibrary, { inputActions, draft, t }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SelectionAddPrompt, { t, enabled: settings.selectionAddEnabled }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      TemplateFillModal,
      {
        open: template !== null,
...
function AIPolishButton(props) {
  ...
  const showToast = (0, import_react9.useCallback)((msg) => setToast(msg), []);
  const closeResult = (0, import_react9.useCallback)(() => {
    setStatus("idle");
    setResult("");
    setError("");
  }, []);
  const handlePolish = (0, import_react9.useCallback)(() => {
    const text = draft.trim();
    if (!text) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { "data-prompt-library-ai-polish": true, style: containerStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("style", { children: PL_BUTTON_CSS }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("style", { children: `@keyframes pl-polish-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }` }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      import_dsh_client_ui_primitives6.Button,
      {
        ...
        icon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SparkleIcon, { spinning: status === "polishing" }),
        children: status === "polishing" ? T("pl.polishing") : T("pl.polish")
      }
    ),
    toast && /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      "span",
      {
        role: "status",
        "aria-live": "polite",
    ...
    status === "done" && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_jsx_runtime11.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("section", { role: "dialog", "aria-label": T("pl.polishResult"), style: panelStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 10 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("strong", { style: { fontSize: 13, fontWeight: 470 }, children: T("pl.polishResult") }),
        error && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { color: TONE9.red, fontSize: 11 }, children: error })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "textarea",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: copyResult, children: T("pl.copy") }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: closeResult, children: T("pl.close") }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.Button, { type: "button", variant: "primary", size: "sm", className: plBtn("primary", "sm"), onClick: applyResult, children: T("pl.replaceContent") })
      ] })
    ] }) })
  ] });
}
...
var MONO9 = '"Microsoft YaHei", "PingFang SC", "Noto Sans SC", "SimHei", "\u9ED1\u4F53", sans-serif';
var TONE10 = {
  text: "var(--dsw-alias-label-primary, #f2f6fc)",
  muted: "var(--dsw-alias-label-secondary, #9daabd)",
  quiet: "var(--dsw-alias-label-tertiary, #718096)",
...
function ModuleCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("section", { style: moduleStyle, children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: moduleTitleStyle, children: title }),
            desc && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: moduleDescStyle, children: desc })
          ] }),
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "flex", flexDirection: "column" }, children })
  ] });
}
function ToggleRow({
  label,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    "label",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { style: { display: "flex", flexDirection: "column", gap: 2, flex: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: 13 }, children: label }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: 11, color: TONE10.quiet }, children: desc })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "input",
          {
            ...
            style: { width: 16, height: 16, cursor: "pointer", accentColor: TONE10.accent }
          }
        )
      ]
    }
...
function NumberRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    "label",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { style: { display: "flex", alignItems: "baseline", gap: 6 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: 13 }, children: label }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { style: { fontSize: 11, color: TONE10.quiet }, children: [
            min,
            "-",
            max
          ] })
...
function TextRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { padding: "8px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      "label",
      {
        style: {
    ...
    desc && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: 11, color: TONE10.quiet, marginTop: 4, lineHeight: 1.5 }, children: desc })
  ] });
}
function SelectRow({
  label,
...
function SettingsSection(props) {
  ...
  const [draft, setDraft] = (0, import_react10.useState)(DEFAULT_SETTINGS);
  const [selectables, setSelectables] = (0, import_react10.useState)([]);
  const [openLearn, setOpenLearn] = (0, import_react10.useState)(false);
  const [openPanel, setOpenPanel] = (0, import_react10.useState)(false);
  const [openDisplay, setOpenDisplay] = (0, import_react10.useState)(false);
  const [openLab, setOpenLab] = (0, import_react10.useState)(false);
  const saveTimerRef = (0, import_react10.useRef)(null);
  (0, import_react10.useEffect)(() => {
    getSettings().then((s) => setDraft(s)).catch(() => {
    }).finally(() => setLoading(false));
    getAiSelectables().then(setSelectables).catch(() => setSelectables([]));
  }, []);
  const saveSettings = (0, import_react10.useCallback)((next) => {
  ...
  const updateAndSave = (0, import_react10.useCallback)((patch) => {
    setDraft((prev) => {
      const next = { ...prev, ...patch };
      saveSettings(next);
      return next;
  ...
  if (loading) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { padding: 16, color: TONE10.quiet, fontFamily: MONO9, fontSize: 13 }, children: T("pl.loading") });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { padding: "2px 0 4px", display: "flex", flexDirection: "column", gap: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: 20, fontWeight: 700, letterSpacing: 1, color: TONE10.text, lineHeight: 1.2 }, children: T("pl.setSectionTitle") }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: 12, color: TONE10.quiet, lineHeight: 1.5 }, children: T("pl.set.setSectionDesc") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          ModuleCard,
          {
            ...
            children: [
              ...
              draft.autoLearnEnabled && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                ToggleRow,
                {
              ...
              draft.autoLearnEnabled && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { paddingLeft: 20 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                  TextRow,
                  {
                ...
                draft.aiEnrichEnabled && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { paddingLeft: 20 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                    SelectRow,
                    {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M12 2l2.4 7.2H22l-6 4.6 2.3 7.2-6.3-4.4L5.7 21 8 13.8 2 9.2h7.6L12 2z", stroke: "currentColor", strokeWidth: "1.5", strokeLinejoin: "round" }) }),
                    "master1Sun"
                  ]
                }
              ),
...
// src/client/SettingsDataSection.tsx
...
function ModuleCard2(props) {
  const { title, desc, open, onToggle, children } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { style: moduleStyle2, children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: moduleTitleStyle2, children: title }),
            desc && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: moduleDescStyle2, children: desc })
          ] }),
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children })
  ] });
}
function PromptCheckRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "label",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("input", { type: "checkbox", checked, onChange: onToggle, style: { marginTop: 2 } }),
...
function SettingsDataSection(props) {
  ...
  const [skillGenerating, setSkillGenerating] = (0, import_react11.useState)(false);
  const [tagList, setTagList] = (0, import_react11.useState)([]);
  const [renamingTag, setRenamingTag] = (0, import_react11.useState)(null);
  const [newTag, setNewTag] = (0, import_react11.useState)("");
  const [trashList, setTrashList] = (0, import_react11.useState)([]);
  const [trashSelected, setTrashSelected] = (0, import_react11.useState)(/* @__PURE__ */ new Set());
  const [trashLoading, setTrashLoading] = (0, import_react11.useState)(false);
  const [openIE, setOpenIE] = (0, import_react11.useState)(false);
  const [openTags, setOpenTags] = (0, import_react11.useState)(false);
  const [openTrash, setOpenTrash] = (0, import_react11.useState)(false);
  ...
  const [pendingConfirm, setPendingConfirm] = (0, import_react11.useState)(null);
  const requestConfirm = (0, import_react11.useCallback)((message, danger, action) => {
  ...
  const refreshPrompts = (0, import_react11.useCallback)(() => {
  ...
  const refreshTags = (0, import_react11.useCallback)(() => {
    listTags().then(
      (list) => setTagList(list),
      (e) => showMsg(e instanceof Error ? e.message : String(e), true)
    );
  }, [showMsg]);
  const refreshTrash = (0, import_react11.useCallback)(() => {
  ...
  const generateSelectedSkills = (0, import_react11.useCallback)(() => {
    const ids = Array.from(exportSelected);
    if (ids.length === 0) {
  ...
  const addTag = (0, import_react11.useCallback)(() => {
  ...
  const confirmRenameTag = (0, import_react11.useCallback)(() => {
  ...
  const removeTag = (0, import_react11.useCallback)(
    (name) => {
  ...
  const toggleTrash = (0, import_react11.useCallback)((id) => {
  ...
  const toggleTrashAll = (0, import_react11.useCallback)(() => {
    setTrashSelected(
      (prev) => prev.size === trashList.length ? /* @__PURE__ */ new Set() : new Set(trashList.map((x) => x.id))
    );
  }, [trashList]);
  const restoreSelected = (0, import_react11.useCallback)(() => {
  ...
  const deleteSelected = (0, import_react11.useCallback)(() => {
    const ids = Array.from(trashSelected);
    if (ids.length === 0) return;
  ...
  const restoreOne = (0, import_react11.useCallback)(
    (item) => {
  ...
  const deleteOne = (0, import_react11.useCallback)(
    (item) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { color: TONE11.text, fontFamily: MONO10, maxWidth: 640 }, children: [
...
` }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { padding: "2px 0 4px", display: "flex", flexDirection: "column", gap: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 20, fontWeight: 700, letterSpacing: 1, color: TONE11.text, lineHeight: 1.2 }, children: T("pl.set.dataSection") }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 12, color: TONE11.quiet, lineHeight: 1.5 }, children: T("pl.set.dataSectionDesc") })
    ] }),
    msg && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "div",
      {
        style: {
          ...
          fontSize: 12,
          lineHeight: 1.5,
          color: msg.error ? TONE11.red : TONE11.text,
          background: TONE11.row,
          border: `1px solid ${TONE11.border}`,
          borderRadius: 6,
          padding: "7px 10px"
      ...
      ModuleCard2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "inline-flex", borderRadius: 7, border: `1px solid ${TONE11.border}`, overflow: "hidden" }, children: ["list", "group"].map((view) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  color: exportView === view ? TONE11.text : TONE11.muted,
                  transition: "background-color .24s cubic-bezier(.22,1,.36,1), color .24s cubic-bezier(.22,1,.36,1)"
                },
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 11, color: TONE11.quiet }, children: exportSelected.size > 0 ? `${exportSelected.size}/${promptList.length}` : T("pl.sidebar.total", { count: promptList.length }) })
          ] }),
          promptLoading ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE11.muted }, children: T("pl.loading") }) : promptList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE11.muted }, children: T("pl.empty") }) : exportView === "group" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10, maxHeight: 300, overflow: "auto" }, children: groupedPrompts.map(([group, prompts]) => {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 11, color: TONE11.quiet }, children: T("pl.sidebar.groupCount", { count: prompts.length }) })
                    ]
                  }
                )
              ] }),
          ...
          }) }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 300, overflow: "auto" }, children: promptList.map((prompt) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            PromptCheckRow,
            {
              title: prompt.title || T("pl.sidebar.uncategorized"),
              body: prompt.body,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      ModuleCard2,
      {
        ...
        children: [
          ...
          tagList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { padding: "10px 0", fontSize: 12, color: TONE11.muted }, children: T("pl.tagsNone") }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 300, overflow: "auto" }, children: tagList.map((tag) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "div",
              {
                ...
                children: editing ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 11, color: TONE11.quiet, flexShrink: 0 }, children: tag.count }),
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                    import_dsh_client_ui_primitives7.Button,
                    {
                      type: "button",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      ModuleCard2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 11, lineHeight: 1.5, color: TONE11.quiet, background: TONE11.row, border: `1px solid ${TONE11.border}`, borderRadius: 6, padding: "6px 10px" }, children: T("pl.trashCleanupNote") }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
              "label",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              import_dsh_client_ui_primitives7.Button,
              {
                ...
                disabled: trashSelected.size === 0,
                style: { color: TONE11.red },
                children: T("pl.trashDeleteSelected")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 11, color: TONE11.quiet }, children: trashSelected.size > 0 ? `${trashSelected.size}/${trashList.length}` : "" })
          ] }),
          trashLoading ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE11.muted }, children: T("pl.loading") }) : trashList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { padding: "12px 0", fontSize: 12, color: TONE11.muted }, children: T("pl.trashEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, maxHeight: 320, overflow: "auto" }, children: trashList.map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 3 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", minWidth: 0 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: { fontSize: 10, color: TONE11.quiet, flexShrink: 0, whiteSpace: "nowrap" }, children: T("pl.trashDeletedAt", { time: formatTime(item.deletedAt) }) })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_dsh_client_ui_primitives7.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => restoreOne(item), children: T("pl.trashRestoreOne") }),
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_dsh_client_ui_primitives7.Button, { type: "button", variant: "ghost", size: "sm", className: plBtn("ghost", "sm"), onClick: () => deleteOne(item), style: { color: TONE11.red }, children: T("pl.trashDeleteOne") }),
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                      "span",
                      {
                        style: {
                          fontSize: 10,
                          color: daysLeft(item.deletedAt) <= 1 ? TONE11.red : TONE11.quiet,
                          marginLeft: "auto",
                          flexShrink: 0
                        },
    ...
    pendingConfirm && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "div",
      {
        style: {
          position: "fixed",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: 10 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                  import_dsh_client_ui_primitives7.Button,
                  {
                    ...
                    size: "sm",
                    className: plBtn("primary", "sm"),
                    style: pendingConfirm.danger ? { color: TONE11.red } : void 0,
                    onClick: () => {
