...
export const zh = {
  ...
  "pl.polishDoneLearn": "润色完成，请复制或插入使用",
  ...
  "pl.set.personTipInterval": "词库助手提示频率(秒, 3-120)",
  "pl.set.personTipDuration": "词库助手显示时长(秒, 1-30)",
  "pl.set.rightPanel": "显示右侧工具面板",
  "pl.set.rightPanelDesc": "在右侧展示词库工具面板，支持拖动调整大小、折叠为助手小人",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.set.personTipInterval": "Library assistant hint interval (s, 3-120)",
  "pl.set.personTipDuration": "Library assistant hint duration (s, 1-30)",
  "pl.set.rightPanel": "Show right tool panel",
  "pl.set.rightPanelDesc": "Show the prompt library panel on the right, draggable & resizable, collapsible into an assistant",
