...
export const zh = {
  ...
  "pl.titleField": "标题",
  "pl.bodyField": "正文",
  "pl.tagsField": "标签（#分隔，可多选）",
  "pl.tagsHint": "输入 # 分隔可一次添加多个标签（如「营销#汇报」）；回车或 # 确认，退格键或 × 删除",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.titleField": "Title",
  "pl.bodyField": "Body",
  "pl.tagsField": "Tags (#-separated, multi)",
  "pl.tagsHint": "Type # to add several tags at once (e.g. marketing#briefing); Enter or # to confirm, Backspace or × to remove",
