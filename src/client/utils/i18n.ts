...
export const zh = {
  ...
  // 官方右侧面板：词库卡片菜单
  "pl.view.menu": "词库",
  "pl.panel.guide.title": "词库面板",
  "pl.panel.guide.desc": "打开词库卡片菜单，集中进入词库管理、导入导出、人格、技能、看板、成就与公告",
  "pl.menu.hint": "点击卡片打开对应功能",
  "pl.menu.empty": "所有功能入口均已关闭，可在「词库设置」中重新开启",
  "pl.menu.desc.lexicon": "提示词增删改查与分类",
  "pl.menu.desc.importExport": "备份与恢复词库数据",
  "pl.menu.desc.persona": "多人格管理与会话绑定",
  "pl.menu.desc.skill": "会话技能注入与项目绑定",
  "pl.menu.desc.dashboard": "使用统计与热力图",
  "pl.menu.desc.achievement": "等级与成就牌组",
  "pl.menu.desc.announce": "使用手册与版本通告",
  "pl.menu.desc.dbPreview": "数据表浏览与增删改查",
  "pl.menu.desc.pluginReco": "插件市场热门榜单",
  "pl.ctx.announce": "公告",
  ...
  "pl.set.rightPanel": "显示右侧面板",
  "pl.set.rightPanelDesc": "在右侧边栏显示词库面板（含数据管理、数据库、插件推荐等入口）；关闭后右侧栏不再出现词库入口",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  // Official right panel: library card menu
  "pl.view.menu": "Library",
  "pl.panel.guide.title": "Library Panel",
  "pl.panel.guide.desc": "Open the library card menu for management, import/export, personas, skills, dashboard, achievements and announcements",
  "pl.menu.hint": "Tap a card to open it",
  "pl.menu.empty": "All entries are disabled — re-enable them in Library settings",
  "pl.menu.desc.lexicon": "Create, edit and organize prompts",
  "pl.menu.desc.importExport": "Back up and restore library data",
  "pl.menu.desc.persona": "Manage personas and session bindings",
  "pl.menu.desc.skill": "Inject session skills and bind projects",
  "pl.menu.desc.dashboard": "Usage stats and heatmap",
  "pl.menu.desc.achievement": "Levels and achievement deck",
  "pl.menu.desc.announce": "Manual and release notes",
  "pl.menu.desc.dbPreview": "Browse tables and edit rows",
  "pl.menu.desc.pluginReco": "Trending plugins from the market",
  ...
  "pl.set.rightPanel": "Show right panel",
  "pl.set.rightPanelDesc": "Show the library panel in the right sidebar (with data management, database, plugin recommendations, etc.); when off, no library entry appears in the right sidebar",
