...
export const zh = {
  ...
  "pl.previewEmpty": "点击左侧列表项，在此查看详情或编辑。",
  ...
  "pl.set.rightPanel": "词库管理",
  "pl.set.rightPanelDesc": "在词库助手右键菜单显示「词库管理」入口，展开词库管理与操作",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.previewEmpty": "Click an item on the left to view or edit it here.",
  ...
  "pl.set.rightPanel": "Library manager",
  "pl.set.rightPanelDesc": "Adds the Library Manager entry to the assistant's context menu for library management and actions. ",
