...
export const zh = {
  ...
  "pl.personas.scopes.viewAll": "工作树和会话",
  "pl.personas.scopes.viewScopes": "工作区/项目",
  "pl.personas.scopes.viewSessions": "会话",
  ...
  "pl.mood.sad": "心情低落",
  "pl.mood.title": "今日心情",
  "pl.mood.bubble.happy": "今天很顺！已完成 {happy} 次圆满对话，心情元气满满～",
  "pl.mood.bubble.sad": "今天有 {sad} 次小波折，别灰心，需要帮忙随时喊我",
  "pl.mood.bubble.neutral": "今天也在勤勉工作，随时待命！",
  ...
  "pl.db.refresh": "刷新数据表",
  "pl.db.rows": "行",
  "pl.db.toolLabel": "数据操作",
  "pl.db.noTables": "暂无数据表",
  "pl.db.columns": "列",
  "pl.db.run": "运行",
  "pl.db.running": "查询中…",
  "pl.db.devMode": "开发者模式",
  "pl.db.devModeOn": "开发者模式 ✓",
  "pl.db.devModeOff": "退出开发者模式",
  "pl.db.devPwTitle": "开启开发者模式",
  "pl.db.devPwMsg": "开发者模式将解锁可视化增删改工具条与 SQL 查询能力，误操作可能损坏数据，请谨慎使用。请输入密码确认开启。",
  "pl.db.devPwPlaceholder": "请输入密码",
  "pl.db.devPwWrong": "密码错误，无法开启",
  "pl.db.devPwConfirm": "确认开启",
  "pl.db.tblDesc.prompts": "提示词库主表",
  "pl.db.tblDesc.tags": "标签",
  "pl.db.tblDesc.trash": "回收站（已删除提示词）",
  "pl.db.tblDesc.meta": "插件元数据",
  "pl.db.tblDesc.usageLog": "使用日志",
  "pl.db.tblDesc.personas": "人格配置",
  "pl.db.tblDesc.personaScopeBindings": "人格-作用域绑定",
  "pl.db.tblDesc.promptScopeBindings": "提示词-作用域绑定",
  "pl.db.tblDesc.promptSkillLinks": "提示词-技能关联",
  "pl.db.tblDesc.sessionPrompts": "会话注入提示词",
  "pl.db.tblDesc.sessionScopeBindings": "会话作用域绑定",
  "pl.db.tblDesc.newspapers": "期刊内容",
  "pl.db.tblDesc.pointsLog": "积分流水",
  "pl.db.tblDesc.achievementProgress": "成就进度",
  "pl.db.tblDesc.statsHistory": "统计历史",
  "pl.db.tblDesc.dailyMood": "每日心情",
  "pl.db.tblDesc.promptVersions": "词条版本历史",
  "pl.db.noRows": "无结果行",
  "pl.db.truncated": "结果超过上限，仅显示前 500 行",
  "pl.db.hint": "点击左侧数据表自动预览，或在右侧输入 SELECT 只读查询（Ctrl/⌘+Enter 运行）",
  "pl.db.sqlEmpty": "请输入查询语句",
  "pl.db.sqlHintTip": "语法提示：输入关键字自动补全，FROM/表名后提示表，表名.后提示列，Enter 选择 · Esc 关闭",
  "pl.db.add": "新增行",
  "pl.db.edit": "编辑",
  "pl.db.del": "删除",
  "pl.db.done": "操作成功",
  "pl.db.notEditable": "该表无主键，不支持可视化编辑",
  "pl.db.selectRowToEdit": "请先点击一行数据",
  "pl.db.deleteConfirm": "确定要删除选中行？此操作不可撤销。",
  "pl.db.deleteDone": "删除成功",
  "pl.db.noFields": "无可编辑字段",
  "pl.db.newRowTitle": "新增行",
  "pl.db.editRow": "编辑行",
  "pl.db.cancel": "取消",
  "pl.db.addConfirm": "新增",
  "pl.db.save": "保存",
  "pl.db.clickRowToEdit": "点击选中行进行编辑/删除",
  "pl.db.ops": "操作",
  "pl.db.auto": "自动",
  ...
  "pl.exporter.btn": "📦 导出产物",
  "pl.exporter.title": "选择要导出的文件",
  "pl.exporter.selectHint": "从 {count} 个文件中选择导出",
  "pl.exporter.deselectAll": "取消全选",
  "pl.exporter.selected": "已选 {selected} / {total}",
  "pl.exporter.noSelection": "请至少选择一个文件",
  "pl.exporter.exporting": "导出中...",
  "pl.exporter.export": "导出 ({count})",
  "pl.exporter.fail": "导出失败，请重试",
  "pl.viewList": "列表",
  "pl.viewGroup": "分类",
  ...
  "pl.skillImportConfirm": "确认从 ~/.dsh/skills 逆向导入？将把每个 SKILL.md 生成为一条提示词（同名技能重复导入会覆盖更新；若同名数据在回收站则自动恢复后导入）。",
  ...
  "pl.set.monitorEnabled": "显示会话监控",
  "pl.set.monitorEnabledDesc": "在会话顶部显示「监控」视图标签，实时查看 token 消耗与活动分析",
  "pl.set.previewEnabled": "显示会话预览",
  "pl.set.previewEnabledDesc": "在会话顶部显示「预览」视图标签，预览会话工作目录下的文件",
  "pl.set.lab": "实验室功能",
  ...
  "pl.updateNotice.title": "需要重启服务",
  "pl.updateNotice.text": "当前运行版本 {server} 与已安装版本 {installed} 不一致，请重启服务以加载最新版本。",
  "pl.pluginReco.title": "插件推荐",
  "pl.pluginReco.detailTitle": "插件详情",
  "pl.pluginReco.pkgName": "包名",
  "pl.pluginReco.version": "版本",
  "pl.pluginReco.license": "许可证",
  "pl.pluginReco.repo": "Git 地址",
  "pl.pluginReco.cloneCmd": "Git 安装命令",
  "pl.pluginReco.dshCmd": "DSH 安装命令",
  "pl.pluginReco.descTitle": "简介",
  "pl.pluginReco.wbName": "文件工作台",
  "pl.pluginReco.wbDesc": "在 DSH 会话内提供资源管理器、代码编辑与多格式预览、文件搜索、Git 面板、多标签终端与 AI 对话等完整文件工作台能力。",
  "pl.ctx.pluginReco": "插件推荐",
  "pl.modulePluginReco": "插件推荐",
  "pl.modulePluginRecoDesc": "来自 DSH 插件市场（dsh-plugin.org）的热门推荐（含广告标识）。实时拉取热门榜单，网络不可用时自动回退显示上一次成功获取的记录。",
  "pl.pluginReco.refresh": "刷新",
  "pl.pluginReco.refreshing": "获取中…",
  "pl.pluginReco.live": "实时",
  "pl.pluginReco.cache": "缓存",
  "pl.pluginReco.cacheAt": "缓存于 {time}",
  "pl.pluginReco.builtin": "内置",
  "pl.pluginReco.reco": "推荐",
  "pl.pluginReco.hot": "热门第 {rank}",
  "pl.pluginReco.stars": "Stars",
  "pl.pluginReco.plName": "提示词词库",
  "pl.pluginReco.plDesc": "提示词词库（本插件）：提示词的收藏、AI 自学习与完善、标签/作用域管理、导入导出与统计，配合 DSH 会话即装即用。",
  "pl.pluginReco.qqName": "QQ 机器人",
  "pl.pluginReco.qqDesc": "把 QQ 官方机器人（Webhook 回调）接入本机 DSH：QQ 群/单聊消息 → DSH 会话 → 回复发回 QQ，支持被动回复与群主动消息。",
  ...
  // 会话预览面板
  "pl.view.preview": "预览",
  "pl.preview.noSession": "暂无会话所属文件夹",
  "pl.preview.noFiles": "当前目录没有可预览文件",
  "pl.preview.loading": "加载中…",
  "pl.preview.refresh": "刷新",
  "pl.preview.openFolder": "打开文件夹",
  "pl.preview.files": "文件",
  "pl.preview.outline": "大纲",
  "pl.preview.showOutline": "展开大纲",
  "pl.preview.hideOutline": "收起大纲",
  "pl.preview.group.md": "Markdown",
  "pl.preview.group.json": "JSON",
  "pl.preview.group.txt": "TXT",
  "pl.preview.group.csv": "CSV",
  "pl.preview.jsonError": "JSON 解析失败，请检查文件内容",
  "pl.preview.truncated": "文件较大，已截断预览，仅显示部分内容",
  "pl.preview.editForbiddenTruncated": "文件已截断，数据不完整，禁止编辑以免覆盖原文件",
  // 全文搜索
  "pl.preview.searchName": "文件名",
  "pl.preview.searchFull": "全文",
  "pl.preview.searchNameMode": "按文件名搜索",
  "pl.preview.searchFullMode": "全文检索文件内容",
  "pl.preview.searchFullPlaceholder": "全文搜索文件内容…",
  "pl.preview.fullSearching": "正在全文检索…",
  "pl.preview.fullNoMatch": "未找到匹配的内容",
  "pl.preview.matchJump": "打开文件并跳转到该行",
  // 大文件分片加载
  "pl.preview.bigHints": "大文件按行分片加载",
  "pl.preview.bigLines": "共 {total} 行",
  // 定位当前文件
  "pl.preview.locateFile": "定位当前文件",
  // 移动/复制到目录
  "pl.preview.moveTitle": "移动到目录",
  "pl.preview.copyTitle": "复制到目录",
  "pl.preview.moveSource": "选择目标目录",
  "pl.preview.moveRoot": "根目录",
  "pl.preview.moveOk": "移动",
  "pl.preview.copyOk": "复制",
  "pl.preview.moving": "处理中…",
  "pl.preview.expand": "展开",
  "pl.preview.collapse": "收起",
  "pl.preview.targetSame": "目标目录与原位置相同，无法移动",
  // 预览文件树/列表右键菜单
  "pl.preview.ctx.copyAbs": "复制完整路径",
  "pl.preview.ctx.copyRel": "复制相对路径",
  "pl.preview.ctx.copyName": "复制文件名",
  "pl.preview.ctx.copyContent": "复制内容",
  "pl.preview.ctx.copyFence": "复制为代码块",
  "pl.preview.ctx.copyLink": "复制为 Markdown 链接",
  "pl.preview.ctx.rename": "重命名",
  "pl.preview.ctx.export": "导出",
  "pl.preview.ctx.edit": "编辑",
  "pl.preview.ctx.moveTo": "移动到…",
  "pl.preview.ctx.copyTo": "复制到…",
  "pl.preview.ctx.delete": "删除",
  "pl.preview.ctx.deleteDir": "删除目录",
  "pl.preview.ctx.newFile": "新建文件",
  "pl.preview.ctx.newDir": "新建目录",
  "pl.preview.ctx.expandAll": "展开全部",
  "pl.preview.ctx.collapseAll": "折叠全部",
  "pl.preview.renameDir": "重命名目录",
  "pl.preview.renameFile": "重命名文件",
  "pl.preview.renameLabel": "新名称",
  "pl.preview.deleteDirTitle": "删除目录",
  "pl.preview.deleteFileTitle": "删除文件",
  "pl.preview.deleteConfirm": "确定删除「{name}」吗？此操作不可恢复。",
  "pl.preview.deleteOk": "删除",
  "pl.preview.newFileTitle": "新建文件",
  "pl.preview.newFileLabel": "文件名",
  "pl.preview.newFilePlaceholder": "如 readme.md / notes.txt",
  "pl.preview.newDirTitle": "新建目录",
  "pl.preview.newDirLabel": "目录名",
  "pl.preview.newDirPlaceholder": "如 docs",
  "pl.preview.create": "创建",
  "pl.preview.ok": "确定",
  "pl.preview.cancel": "取消",
  "pl.preview.toast.copied": "已复制到剪贴板",
  "pl.preview.toast.copyFailed": "复制失败",
  "pl.preview.toast.readFailed": "读取文件失败",
  "pl.preview.toast.opSuccess": "操作成功",
  "pl.preview.toast.opFailed": "操作失败",
  "pl.preview.toast.exported": "已导出",
  "pl.preview.toast.noExportable": "目录下没有可导出的文件",
  "pl.preview.toast.exportFailed": "导出失败，请重试",
  "pl.preview.zip.dirTitle": "导出为 ZIP",
  "pl.preview.zip.selectAll": "全选",
  "pl.preview.zip.unselectAll": "取消全选",
  "pl.preview.zip.selected": "已选 {n} / {total}",
  "pl.preview.zip.exporting": "导出中...",
  "pl.preview.zip.export": "导出 ({n})",
  "pl.preview.dialog.nameEmpty": "名称不能为空",
  "pl.preview.dialog.nameInvalid": "名称不能包含 / \\ 或 ..",
  "pl.preview.editFile": "编辑文件",
  "pl.preview.cancelEdit": "取消编辑",
  "pl.preview.saveFile": "保存文件",
  "pl.preview.save": "保存",
  "pl.preview.saving": "保存中...",
  "pl.preview.smartClassify": "智能分类",
  "pl.preview.smart": "智能",
  "pl.preview.type": "类型",
  "pl.preview.all": "全部",
  "pl.preview.searchPlaceholder": "搜索文件名...",
  "pl.preview.name": "名称",
  "pl.preview.size": "大小",
  "pl.preview.modified": "修改时间",
  "pl.preview.toggleOrder": "切换升序/降序",
  "pl.preview.groupView": "分组视图",
  "pl.preview.listView": "列表视图",
  "pl.preview.noMatch": "未找到匹配的文件",
  "pl.preview.noFilesInType": "此类型下没有文件",
  "pl.preview.toast.saveOk": "保存成功",
  "pl.preview.toast.saveFail": "保存失败，请重试",
  ...
  "pl.monitor.tokenVelocity": "Token 流速",
  "pl.monitor.inputPerTurn": "输入 token / 轮",
  "pl.monitor.outputPerTurn": "输出 token / 轮",
  "pl.monitor.activityHeatmap": "会话活动热力图",
  "pl.monitor.anomalies": "异常检测",
  "pl.monitor.turnLabel": "第 {turn} 轮",
  "pl.monitor.slowResponse": "响应缓慢",
  "pl.monitor.sectionActivity": "会话动态",
  "pl.monitor.you": "用户",
  "pl.monitor.assistant": "助手",
  "pl.monitor.thinking": "思考",
  "pl.monitor.kindError": "失败",
  "pl.monitor.kindRetry": "重试",
  "pl.monitor.kindMaxTokens": "截断",
  "pl.monitor.kindInterrupted": "中断",
  "pl.monitor.noActivity": "暂无对话消息",
  "pl.monitor.tabContent": "内容",
  "pl.monitor.tabParams": "参数",
  "pl.monitor.tabObject": "对象",
  "pl.monitor.failed": "失败",
  "pl.monitor.evtError": "回合失败",
  "pl.monitor.evtRetry": "等待重试",
  "pl.monitor.evtMaxTokens": "输出达到上限",
  "pl.monitor.evtInterrupted": "回复被中断",
  "pl.monitor.cost": "预估花费",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.personas.scopes.viewAll": "Tree & Session",
  "pl.personas.scopes.viewScopes": "Workspace/Project",
  "pl.personas.scopes.viewSessions": "Sessions",
  ...
  "pl.mood.happy": "Feeling great",
  "pl.mood.sad": "Feeling low",
  "pl.mood.title": "Today's Mood",
  "pl.mood.bubble.happy": "Great run! {happy} smooth conversations today, feeling energetic~",
  "pl.mood.bubble.sad": "{sad} little bumps today — don't worry, just call me when you need a hand",
  "pl.mood.bubble.neutral": "Been working hard today, always on standby!",
  ...
  "pl.db.tables": "Tables",
  "pl.db.refresh": "Refresh tables",
  "pl.db.rows": "rows",
  "pl.db.toolLabel": "Row operations",
  "pl.db.noTables": "No tables",
  "pl.db.columns": "Columns",
  "pl.db.run": "Run",
  "pl.db.running": "Running…",
  "pl.db.devMode": "Developer mode",
  "pl.db.devModeOn": "Developer mode ✓",
  "pl.db.devModeOff": "Exit developer mode",
  "pl.db.devPwTitle": "Enable developer mode",
  "pl.db.devPwMsg": "Developer mode unlocks the visual CRUD toolbar and SQL query capability. Misoperation may corrupt data, so use it with caution. Enter the password to confirm.",
  "pl.db.devPwPlaceholder": "Enter password",
  "pl.db.devPwWrong": "Incorrect password",
  "pl.db.devPwConfirm": "Enable",
  "pl.db.tblDesc.prompts": "Prompt library main table",
  "pl.db.tblDesc.tags": "Tags",
  "pl.db.tblDesc.trash": "Trash (deleted prompts)",
  "pl.db.tblDesc.meta": "Plugin metadata",
  "pl.db.tblDesc.usageLog": "Usage log",
  "pl.db.tblDesc.personas": "Personas",
  "pl.db.tblDesc.personaScopeBindings": "Persona scope bindings",
  "pl.db.tblDesc.promptScopeBindings": "Prompt scope bindings",
  "pl.db.tblDesc.promptSkillLinks": "Prompt–skill links",
  "pl.db.tblDesc.sessionPrompts": "Session injected prompts",
  "pl.db.tblDesc.sessionScopeBindings": "Session scope bindings",
  "pl.db.tblDesc.newspapers": "Newspaper content",
  "pl.db.tblDesc.pointsLog": "Points log",
  "pl.db.tblDesc.achievementProgress": "Achievement progress",
  "pl.db.tblDesc.statsHistory": "Statistics history",
  "pl.db.tblDesc.dailyMood": "Daily mood",
  "pl.db.tblDesc.promptVersions": "Prompt version history",
  "pl.db.noRows": "No result rows",
  "pl.db.truncated": "Results exceed the limit; only the first 500 rows are shown",
  "pl.db.hint": "Click a table on the left to preview it, or type a read-only SELECT query (Ctrl/⌘+Enter to run)",
  "pl.db.sqlEmpty": "Please enter a query",
  "pl.db.sqlHintTip": "Syntax hints: keywords auto-complete; tables shown after FROM; columns after table. Enter to accept · Esc to close",
  "pl.db.add": "Add row",
  "pl.db.edit": "Edit",
  "pl.db.del": "Delete",
  "pl.db.done": "Done",
  "pl.db.notEditable": "This table has no primary key; inline editing is not supported",
  "pl.db.selectRowToEdit": "Click a row first",
  "pl.db.deleteConfirm": "Delete the selected row? This cannot be undone.",
  "pl.db.deleteDone": "Deleted",
  "pl.db.noFields": "No editable fields",
  "pl.db.newRowTitle": "New row",
  "pl.db.editRow": "Edit row",
  "pl.db.cancel": "Cancel",
  "pl.db.addConfirm": "Add",
  "pl.db.save": "Save",
  "pl.db.clickRowToEdit": "Click a row to edit / delete",
  "pl.db.ops": "Actions",
  "pl.db.auto": "Auto",
  ...
  "pl.exporter.btn": "📦 Export artifacts",
  "pl.exporter.title": "Select files to export",
  "pl.exporter.selectHint": "Select from {count} files",
  "pl.exporter.deselectAll": "Deselect all",
  "pl.exporter.selected": "{selected} / {total} selected",
  "pl.exporter.noSelection": "Please select at least one file",
  "pl.exporter.exporting": "Exporting...",
  "pl.exporter.export": "Export ({count})",
  "pl.exporter.fail": "Export failed, please retry",
  "pl.viewList": "List",
  ...
  "pl.skillImportConfirm": "Reverse-import from ~/.dsh/skills? Each SKILL.md becomes a prompt (re-importing the same skill overwrites/updates; if the matching data is in trash it is restored first).",
  ...
  "pl.set.monitorEnabled": "Show conversation monitor",
  "pl.set.monitorEnabledDesc": "Show the \u201cMonitor\u201d view tab at the top of a conversation, with real-time token usage and activity analysis",
  "pl.set.previewEnabled": "Show conversation preview",
  "pl.set.previewEnabledDesc": "Show the \u201cPreview\u201d view tab at the top of a conversation to preview files in its working directory",
  ...
  "pl.updateNotice.title": "Restart required",
  "pl.updateNotice.text": "The running version {server} differs from the installed version {installed}. Please restart the service to load the latest version.",
  "pl.pluginReco.title": "Plugins",
  "pl.pluginReco.detailTitle": "Plugin details",
  "pl.pluginReco.pkgName": "Package",
  "pl.pluginReco.version": "Version",
  "pl.pluginReco.license": "License",
  "pl.pluginReco.repo": "Git URL",
  "pl.pluginReco.cloneCmd": "Git install command",
  "pl.pluginReco.dshCmd": "DSH install command",
  "pl.pluginReco.descTitle": "About",
  "pl.pluginReco.wbName": "File Workbench",
  "pl.pluginReco.wbDesc": "Brings a full file workbench into DSH sessions: explorer, code editing, rich previews, file search, Git panel, multi-tab terminal and AI chat.",
  "pl.ctx.pluginReco": "Plugins",
  "pl.modulePluginReco": "Plugin recommendations",
  "pl.modulePluginRecoDesc": "Hot picks from the DSH plugin market (dsh-plugin.org), marked as ads. The hot list is fetched live; when the network is unavailable the last cached result is shown instead.",
  "pl.pluginReco.refresh": "Refresh",
  "pl.pluginReco.refreshing": "Fetching…",
  "pl.pluginReco.live": "Live",
  "pl.pluginReco.cache": "Cached",
  "pl.pluginReco.cacheAt": "Cached at {time}",
  "pl.pluginReco.builtin": "Built-in",
  "pl.pluginReco.reco": "Rec.",
  "pl.pluginReco.hot": "Hot #{rank}",
  "pl.pluginReco.stars": "Stars",
  "pl.pluginReco.plName": "Prompt Library",
  "pl.pluginReco.plDesc": "Prompt Library (this plugin): collect prompts, AI self-learning and refinement, tag/scope management, import/export and stats. Works out of the box with DSH sessions.",
  "pl.pluginReco.qqName": "QQ Bot",
  "pl.pluginReco.qqDesc": "Connect the official QQ bot (webhook callback) to a local DSH: QQ group/chat messages become DSH sessions and replies are sent back to QQ, with passive replies and proactive group messages.",
  ...
  "pl.view.preview": "Preview",
  "pl.preview.noSession": "No session folder",
  "pl.preview.noFiles": "No previewable files in this directory",
  "pl.preview.loading": "Loading…",
  "pl.preview.refresh": "Refresh",
  "pl.preview.openFolder": "Open Folder",
  "pl.preview.files": "Files",
  "pl.preview.outline": "Outline",
  "pl.preview.showOutline": "Show outline",
  "pl.preview.hideOutline": "Hide outline",
  "pl.preview.group.md": "Markdown",
  "pl.preview.group.json": "JSON",
  "pl.preview.group.txt": "TXT",
  "pl.preview.group.csv": "CSV",
  "pl.preview.jsonError": "Failed to parse JSON, please check the file",
  "pl.preview.truncated": "File is large; preview truncated to show partial content",
  "pl.preview.editForbiddenTruncated": "File was truncated; editing is disabled to avoid overwriting the original",
  // Full-text search
  "pl.preview.searchName": "File name",
  "pl.preview.searchFull": "Full text",
  "pl.preview.searchNameMode": "Search by file name",
  "pl.preview.searchFullMode": "Search file contents",
  "pl.preview.searchFullPlaceholder": "Search file contents…",
  "pl.preview.fullSearching": "Searching contents…",
  "pl.preview.fullNoMatch": "No matching content found",
  "pl.preview.matchJump": "Open file and jump to line",
  // Large file sharded loading
  "pl.preview.bigHints": "Large file loaded line by line",
  "pl.preview.bigLines": "{total} lines",
  // Locate current file
  "pl.preview.locateFile": "Locate current file",
  // Move / copy to directory
  "pl.preview.moveTitle": "Move to directory",
  "pl.preview.copyTitle": "Copy to directory",
  "pl.preview.moveSource": "Select target directory",
  "pl.preview.moveRoot": "Root",
  "pl.preview.moveOk": "Move",
  "pl.preview.copyOk": "Copy",
  "pl.preview.moving": "Working…",
  "pl.preview.expand": "Expand",
  "pl.preview.collapse": "Collapse",
  "pl.preview.targetSame": "Target directory is the same as the current location",
  // Preview file tree/list context menu
  "pl.preview.ctx.copyAbs": "Copy full path",
  "pl.preview.ctx.copyRel": "Copy relative path",
  "pl.preview.ctx.copyName": "Copy file name",
  "pl.preview.ctx.copyContent": "Copy content",
  "pl.preview.ctx.copyFence": "Copy as code block",
  "pl.preview.ctx.copyLink": "Copy as Markdown link",
  "pl.preview.ctx.rename": "Rename",
  "pl.preview.ctx.export": "Export",
  "pl.preview.ctx.edit": "Edit",
  "pl.preview.ctx.moveTo": "Move to…",
  "pl.preview.ctx.copyTo": "Copy to…",
  "pl.preview.ctx.delete": "Delete",
  "pl.preview.ctx.deleteDir": "Delete folder",
  "pl.preview.ctx.newFile": "New file",
  "pl.preview.ctx.newDir": "New folder",
  "pl.preview.ctx.expandAll": "Expand all",
  "pl.preview.ctx.collapseAll": "Collapse all",
  "pl.preview.renameDir": "Rename folder",
  "pl.preview.renameFile": "Rename file",
  "pl.preview.renameLabel": "New name",
  "pl.preview.deleteDirTitle": "Delete folder",
  "pl.preview.deleteFileTitle": "Delete file",
  "pl.preview.deleteConfirm": "Delete \"{name}\"? This cannot be undone.",
  "pl.preview.deleteOk": "Delete",
  "pl.preview.newFileTitle": "New file",
  "pl.preview.newFileLabel": "File name",
  "pl.preview.newFilePlaceholder": "e.g. readme.md / notes.txt",
  "pl.preview.newDirTitle": "New folder",
  "pl.preview.newDirLabel": "Folder name",
  "pl.preview.newDirPlaceholder": "e.g. docs",
  "pl.preview.create": "Create",
  "pl.preview.ok": "OK",
  "pl.preview.cancel": "Cancel",
  "pl.preview.toast.copied": "Copied to clipboard",
  "pl.preview.toast.copyFailed": "Copy failed",
  "pl.preview.toast.readFailed": "Failed to read file",
  "pl.preview.toast.opSuccess": "Operation succeeded",
  "pl.preview.toast.opFailed": "Operation failed",
  "pl.preview.toast.exported": "Exported",
  "pl.preview.toast.noExportable": "No exportable files under this folder",
  "pl.preview.toast.exportFailed": "Export failed, please retry",
  "pl.preview.zip.dirTitle": "Export as ZIP",
  "pl.preview.zip.selectAll": "Select all",
  "pl.preview.zip.unselectAll": "Deselect all",
  "pl.preview.zip.selected": "{n} / {total} selected",
  "pl.preview.zip.exporting": "Exporting...",
  "pl.preview.zip.export": "Export ({n})",
  "pl.preview.dialog.nameEmpty": "Name cannot be empty",
  "pl.preview.dialog.nameInvalid": "Name cannot contain / \\ or ..",
  "pl.preview.editFile": "Edit file",
  "pl.preview.cancelEdit": "Cancel edit",
  "pl.preview.saveFile": "Save file",
  "pl.preview.save": "Save",
  "pl.preview.saving": "Saving…",
  "pl.preview.smartClassify": "Smart classify",
  "pl.preview.smart": "Smart",
  "pl.preview.type": "Type",
  "pl.preview.all": "All",
  "pl.preview.searchPlaceholder": "Search file names...",
  "pl.preview.name": "Name",
  "pl.preview.size": "Size",
  "pl.preview.modified": "Modified",
  "pl.preview.toggleOrder": "Toggle ascending / descending",
  "pl.preview.groupView": "Group view",
  "pl.preview.listView": "List view",
  "pl.preview.noMatch": "No matching files",
  "pl.preview.noFilesInType": "No files in this type",
  "pl.preview.toast.saveOk": "Saved",
  "pl.preview.toast.saveFail": "Save failed, please retry",
  ...
  "pl.monitor.tokenVelocity": "Token velocity",
  "pl.monitor.inputPerTurn": "Input tokens / turn",
  "pl.monitor.outputPerTurn": "Output tokens / turn",
  "pl.monitor.activityHeatmap": "Session activity heatmap",
  "pl.monitor.anomalies": "Anomaly detection",
  "pl.monitor.turnLabel": "Turn {turn}",
  "pl.monitor.slowResponse": "Slow response",
  "pl.monitor.sectionActivity": "Session Activity",
  "pl.monitor.you": "You",
  "pl.monitor.assistant": "Assistant",
  "pl.monitor.thinking": "Thinking",
  "pl.monitor.kindError": "Failed",
  "pl.monitor.kindRetry": "Retry",
  "pl.monitor.kindMaxTokens": "Truncated",
  "pl.monitor.kindInterrupted": "Interrupted",
  "pl.monitor.noActivity": "No conversation yet",
  "pl.monitor.tabContent": "Content",
  "pl.monitor.tabParams": "Params",
  "pl.monitor.tabObject": "Object",
  "pl.monitor.failed": "Failed",
  "pl.monitor.evtError": "Turn failed",
  "pl.monitor.evtRetry": "Retry pending",
  "pl.monitor.evtMaxTokens": "Output limit reached",
  "pl.monitor.evtInterrupted": "Reply interrupted",
  "pl.monitor.cost": "Est. cost",
