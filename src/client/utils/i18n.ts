...
export const zh = {
  ...
  "pl.workbenchNotice.title": "workbench 已安装",
  "pl.workbenchNotice.text": "词库文件工作台（workbench）已安装完成，请重启服务后生效。",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "pl.workbenchNotice.title": "Workbench installed",
  "pl.workbenchNotice.text": "The file workbench has been installed. Please restart the service to activate it.",
