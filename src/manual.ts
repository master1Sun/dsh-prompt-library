...
export const manualZh = [
  ...
  "/prompts -enrich <正文>     AI 专业完善：与 -AI 润色相反，扩写完善为更专业/全面/结构完整的版本并填充到聊天框",
...
export const manualEn = [
  ...
  "/prompts -enrich <body>     AI professional enrichment: opposite of -AI polish, expand into a more professional/complete/structured version and fill into the input box",
